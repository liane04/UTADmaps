    ...
    <View style={styles.container}>
      ...
      <View style={styles.mapBackground}>
        ...
        <View style={[styles.building, { top: 100, left: 50, width: 120, height: 40, transform: [{ rotate: '20deg' }] }]}>
          <Text style={styles.buildingText}>Bloco A</Text>
        </View>
        ...
        <View style={[styles.building, styles.targetBuilding, { top: 400, left: 250, width: 120, height: 100, transform: [{ rotate: '20deg' }] }]}>
          <Text style={styles.buildingText}>Biblioteca</Text>
        </View>
      ...
      <SafeAreaView edges={['top']} style={styles.header}>
        <TouchableOpacity style={styles.backButton} onPress={() => router.back()}>
          ...
          <Text style={styles.headerTitle}>Navegacao Outdoor</Text>
        </TouchableOpacity>
      </SafeAreaView>
      ...
      <View style={styles.bottomPanel}>
        ...
        <View style={styles.infoRow}>
          <View>
            <Text style={styles.timeDistance}>450m - 6 min a pe</Text>
            <Text style={styles.instruction}>Siga em frente e vire a direita</Text>
          </View>
          
          <View style={styles.modeToggle}>
            <View style={[styles.modePill, styles.modePillActive]}>
              <Text style={[styles.modeText, styles.modeTextActive]}>A pe</Text>
            </View>
            <View style={styles.modePill}>
              <Text style={styles.modeText}>Carro</Text>
            </View>
          </View>
        </View>
