...
| **M-13** | Implementar *clustering* de marcadores no mapa para zooms inferiores | P-06 cosmético | 🟢 Baixo | Médio | **III** |
...
Quadrante II — melhorias com impacto significativo mas que exigem mais tempo.
...
A implementação destas oito acções de prioridade máxima eleva a aplicação de **92 % de taxa de sucesso** para uma estimativa de **97–98 %**, eliminando os obstáculos detectados pelas três técnicas de avaliação e tornando o produto pronto para uso em produção pela comunidade académica da UTAD.
